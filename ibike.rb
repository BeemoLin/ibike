...
ibikeLocation = {
	...
	"中正國小" => {"lat" => "24.152514", "lng" => "120.666314"},
	"科博館/金典酒店" => {"lat" => "24.155495", "lng" => "120.663068"},
	"茄苳腳" => {"lat" => "24.150021", "lng" => "120.671245"},
	...
	"新光/遠百" => {"lat" => "24.165977", "lng" => "120.643178"},
	"頂何厝" => {"lat" => "24.159105", "lng" => "120.655826"},
	...
	"三光太原路口" => {"lat" => "24.164793", "lng" => "120.696686"},
	"育德梅川東路口" => {"lat" => "24.157469", "lng" => "120.675331"},
	"青海逢甲路口" => {"lat" => "24.174687", "lng" => "120.639051"},
	"上石公園" => {"lat" => "24.172868", "lng" => "120.644939"},
	"經國園道" => {"lat" => "24.146806", "lng" => "120.664768"},
	"黎明國中" => {"lat" => "24.156499", "lng" => "120.634358"},
	"英才公園" => {"lat" => "24.155684", "lng" => "120.670978"},
	"惠文高中" => {"lat" => "24.153646", "lng" => "120.640325"},
	"崇倫公園" => {"lat" => "24.132333", "lng" => "120.661091"},
	"豐樂雕塑公園" => {"lat" => "24.132020", "lng" => "120.643469"},
	...
	"中正公園(南北管音樂戲曲館)" => {"lat" => "24.068038", "lng" => "120.531161"},
